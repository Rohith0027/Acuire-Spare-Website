...
<body>
    ...
    <?php 
        require 'config.php';
        $ro = $_SESSION['email'];
        $query = "SELECT * FROM `items` WHERE email = '$ro'";
        ...
        if($check_product){
            ...
            <div class="box">
                ...
                <div class="info">
                    <h3 class="title"><?php echo $row['title'];?> (<?php echo $row['catogery'];?>)</h3>
                    <h4 class="description"><?php echo $row['description'];?></h4>
                    <form action="update.php" method="post">
                        <a href="update.php?edit=<?php echo $row['title']; ?>" class="bt"  name="edit"><i class="fas fa-edit"></i>Edit</a>
                        <a href="merchant.php?delete=<?php echo $row['title']; ?>" class="bt"  name="delete"><i class="fas fa-trash"></i>Delete</a>   
                    </form>
                    <div class="subinfo">
                ...
                <div class="overlay">
                    <a href="#" style="--i:1;" class="fa-solid fa-share"></a>
                </div>
            </div>
            <?php
            }
...
require 'config.php';
    if(isset($_GET['delete'])){
        $id = $_GET['delete'];
        mysqli_query($conn , "DELETE FROM items WHERE title='$id'");
